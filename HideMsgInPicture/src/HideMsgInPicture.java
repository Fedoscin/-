...
public class HideMsgInPicture {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(HideMsgInPicture::createAndShowGUI);
    }
    ...
    private static String encode(String imagePath, String message) throws IOException {
        ...
        try (FileInputStream in = new FileInputStream(imagePath); FileOutputStream out = new FileOutputStream("encoded_image.bmp")) {
            int c;
            int mb;
    ...
    private static String decode(String imagePath) throws IOException {
        ...
        try (FileInputStream in = new FileInputStream(imagePath); ByteArrayOutputStream out = new ByteArrayOutputStream()) {
    ...
    private static void saveImage(BufferedImage image) {
        try {
            ImageIO.write(image, "bmp", new File(getExecutablePath() + File.separator + "changed_pixels_image.bmp"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
